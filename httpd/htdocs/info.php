<?php
/*
This was brought to you by dhtmlextreme.net
*/
//on rs les versions des applis
$phpVersion = "7.0.8";
$apacheVersion = "2.4.20";
$mysqlVersion = "5.7";
$dhtmlserverVersion = "4.0 phpbrowserbox server";
...
$langues = array(
	'en' => array(
		...
		'faq' => 'http://www.en.dhtmlserver.com/faq.php'
	),
	'fr' => array(
		'langue' => 'Fran?s',
		...
		'faq' => 'http://www.dhtmlserver.com/faq.php'
	)
);
...
while ($file = readdir($handle)) 
{
	...
	{
		if($file=='theme'||$file=='phpminiadmin'||$file=='phpmyadmin') {continue;}
...
<head>
	<title>PHPBrowserBox Admin</title>
...
<a href="index.php">&laquo; Return to PHPBrowserBox</a>
	<ul class="utility">
		<li>Version ${dhtmlserverVersion}</li>
	</ul>
	...
	<ul class="tools">
		...
		<li><a href="phpminiadmin/">phpminiadmin</a></li>
	</ul>
	...
	<ul id="foot">
		<li><a href="/">PHPBrowserBox Home</a></li>
	</ul>
</body>
</html>
EOPAGE;
